<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/MangerMaster.master" AutoEventWireup="true" CodeFile="SearchCustomer.aspx.cs" Inherits="Manager_SearchCustomer" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageTitle" Runat="Server">
Search Customer</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="PageHeader" Runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <fieldset>
    <legend style="font-size:20px">Search Customer</legend>
    ...
    <div class="formLayout">
            <p>
                ...
                <asp:TextBox ID="txtSearch" CssClass="inputs" placeholder="Search by Name" runat="server"></asp:TextBox>
            </p>
            <p>
                <label>
                </label>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT Id, FirstName, LastName, Email, Password FROM Customer WHERE (Email Like '%'+@Search+'%')" 
